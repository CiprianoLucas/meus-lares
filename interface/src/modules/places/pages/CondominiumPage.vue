<template>
    <div v-if="condominium.id">
        ...
        >
            ...
            <img
                v-if="condominium.profile_photo"
                :src="condominium.profile_photo"
                class="condominium-img"
                alt="foto do condomínio"
            />
            <button @click="triggerFileInput" class="btn btn-secondary py-0 my-1">
                <small>Alterar foto do condominio</small>
            </button>
        ...
        <div class="border-bottom px-4 py-3">
            <div class="d-flex justify-content-between mb-3">
                ...
                <router-link
                    :to="'/condominio/edicao/' + condominiumId"
...
async function photoChange(event: Event) {
    ...
    if (file) {
        ...
        app.api
            .patch('/place/condominium/' + condominiumId.value + '/', formData)
            .then(() => {
