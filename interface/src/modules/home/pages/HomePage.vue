                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Visualize e acompanhe seus chamados de manutenção e reclamação.
                            </p>
                            <router-link to="/requisicao/minhas-requisicoes" class="btn btn-primary"
                                >Ver Chamados</router-link
                            >
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Abra um novo chamado de manutenção ou reclamação.
                            </p>
                            <router-link to="/requisicao/cadastro" class="btn btn-primary"
                                >Criar Chamado</router-link
                            >
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <router-link to="/fatura/lista" class="btn btn-primary"
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <router-link to="/requisicao/pendentes" class="btn btn-primary"
                                >Ver Chamados Abertos</router-link
                            >
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <router-link to="/requisicao/capturados" class="btn btn-primary"
                                >Ver chamados capturados</router-link
                            >
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <router-link to="/condominio/lista" class="btn btn-secondary"
