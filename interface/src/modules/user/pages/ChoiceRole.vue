    ...
    <div class="mt-4">
        ...
        <div class="row">
            <div v-if="user.roles.length == 0">
                <div
                    class="d-flex justify-content-center align-items-center border rounded p-3 mt-3"
                >
                    <p class="text-center">
                        ...
                        Verifique nas notificações ou em seu email se não há uma solicitação de
                        registro para ser aprovada.
                    </p>
                </div>
            </div>
            <div v-if="user.roles.includes('tenant')" class="col-6 p-3">
                <router-link
                    to="/morador"
                    @click="userstore.role = 'tenant'"
                    class="text-white text-decoration-none"
                >
                    <div class="card d-flex justify-content-center align-items-center">
                        <img
                            src="https://static.vecteezy.com/ti/vetor-gratis/p1/6883355-inquilinos-casa-residentes-icone-em-branco-vetor.jpg"
                            class="card-img-top"
                            alt="morador"
                        />
                        <div class="card-body">
            ...
            <div v-if="user.roles.includes('owner')" class="col-6 p-3">
                <router-link
                    to="/proprietario"
                    @click="userstore.role = 'owner'"
                    class="text-white text-decoration-none"
                >
                    <div class="card d-flex justify-content-center align-items-center">
                        <img
                            src="https://cdn-icons-png.flaticon.com/512/2098/2098368.png"
                            class="card-img-top"
                            alt="morador"
                        />
                        <div class="card-body">
