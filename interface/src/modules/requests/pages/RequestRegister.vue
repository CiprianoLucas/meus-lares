<template>
    <div class="container mt-5">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="place" v-model="requestForm.place" required>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="type" v-model="requestForm.type" required>
        ...
        <button v-if="!requestId" @click="registerRequest" class="btn btn-primary">
            Cadastrar
        </button>
...
function registerRequest() {
    app.api
        .post('/request/', requestForm.value)
        .then(({ data }) => {
...
function updatePlace() {
    app.api
        .put(`/request/${requestId.value}/`, requestForm.value)
        .then(() => {
            sessionStorage.removeItem('/request/residents/')
            app.redirect('/requisicao/minhas-requisicoes')
        })
