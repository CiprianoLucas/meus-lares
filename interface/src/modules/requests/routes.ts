export default [
    ...
    },
    {
        ...
        component: () => import(/* webpacjChunkName: "listar requisições capturados" */ './pages/RequestListCaptureds.vue')
    },
    {
        path: '/requisicao/minhas-requisicoes', //don't forget insert in router folder
        name: 'requisicao_minhas_requisicoes', 
        component: () => import(/* webpacjChunkName: "listar minhas requisições" */ './pages/RequestListMy.vue')
    },
]