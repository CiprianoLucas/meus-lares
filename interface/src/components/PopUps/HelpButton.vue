<template>
    <button :data-bs-toggle="modal?'modal':''" :data-bs-target="'#helpModal-'+id" ref="tooltipButton"
        class="btn btn-outline-secondary rounded-circle m-0 p-0 ms-2">
        <i class="bi bi-question"></i></button>
    <div class="modal fade" :id="'helpModal-'+id" tabindex="-1" :aria-labelledby="'helpModalLabel-'+id" aria-hidden="true">
